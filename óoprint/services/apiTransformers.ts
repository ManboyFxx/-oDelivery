import { DBOrder, DBOrderItem, DBOrderItemComplement, DBCustomer, DBAddress } from '../types';
import { ApiOrderResponse, ApiOrderItem, ApiOrderItemComplement } from './restApiClient';
...
export function transformApiCustomer(customer: { name: string; phone: string }): DBCustomer {
  return {
...
export function transformApiComplement(
  complement: ApiOrderItemComplement
  ...
  return {
    ...
    price: parseBrazilianCurrency(complement.price),
    quantity: 1,
  };
}
