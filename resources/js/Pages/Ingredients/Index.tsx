...
import { Plus, Search, Filter, MoreHorizontal, Edit, Trash2, Power, AlertTriangle, Package, Beaker, ChevronRight, Save } from 'lucide-react';
...
export default function IngredientsIndex({ ingredients }: Props) {
    ...
    return (
        <AuthenticatedLayout>
            <Head title="Gerenciamento de Ingredientes" />

            <div className="flex h-full flex-col space-y-8">
                <PageHeader
                    title="Ingredientes"
                    subtitle="Gerencie os insumos e composições dos seus produtos."
                    action={
                        <button
                            onClick={handleOpenCreate}
                            className="flex items-center gap-2 rounded-2xl bg-[#ff3d03] px-6 py-3 text-sm font-bold text-white shadow-lg shadow-[#ff3d03]/20 hover:bg-[#e63602] transition-all"
                        >
                                    ...
                                    <div className="p-3 bg-gray-50 dark:bg-white/2 rounded-2xl">
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm font-black text-gray-900 dark:text-white">
                                                {ingredient.complement_options_count || 0} opções
                                            </span>
                                        </div>
                                    </div>
                                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-white/2 rounded-2xl">
                            ...
                            />
                            <label htmlFor="is_available" className="text-sm font-bold text-gray-700 dark:text-gray-300 cursor-pointer select-none">
