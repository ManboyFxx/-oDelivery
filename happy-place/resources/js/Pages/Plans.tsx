...
export default function Plans() {
    return (
        <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-[#ff3d03] selection:text-white">
            ...
            {/* Navigation (Simplified for this page or imports shared Layout if available, replicating simplified nav for now) */}
                ...
                <div className="max-w-7xl mx-auto px-6 lg:px-8 mb-32">
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="relative p-8 rounded-3xl border border-gray-200 bg-white hover:border-[#ff3d03]/30 hover:shadow-2xl hover:shadow-[#ff3d03]/5 transition-all duration-300">
                            <div className="mb-6">
                                <h3 className="text-lg font-bold text-gray-500 uppercase tracking-wider mb-2">Básico</h3>
                                <div className="flex items-baseline gap-1">
                                    <span className="text-5xl font-black text-gray-900">R$0</span>
                                    <span className="text-gray-500 font-medium">/mês</span>
                                </div>
                                <p className="text-gray-400 text-sm mt-2">Ideal para quem está começando agora.</p>
                            </div>
                        ...
                        <div className="relative p-8 rounded-3xl border-2 border-[#ff3d03] bg-white shadow-xl shadow-[#ff3d03]/10 scale-105 z-10">
                            ...
                            <div className="mb-6">
                                <h3 className="text-lg font-bold text-[#ff3d03] uppercase tracking-wider mb-2">Profissional</h3>
                                <div className="flex items-baseline gap-1">
                                    <span className="text-5xl font-black text-gray-900">R$89</span>
                                    <span className="text-gray-500 font-medium">/mês</span>
                                </div>
                                <p className="text-gray-400 text-sm mt-2">Para deliverys que vendem todo dia.</p>
                            </div>
                            <ul className="space-y-4 mb-8">
                        ...
                        <div className="relative p-8 rounded-3xl border border-gray-200 bg-white hover:border-[#ff3d03]/30 hover:shadow-2xl hover:shadow-[#ff3d03]/5 transition-all duration-300">
                            <div className="mb-6">
                                <h3 className="text-lg font-bold text-gray-500 uppercase tracking-wider mb-2">Redes</h3>
                                <div className="flex items-baseline gap-1">
                                    <span className="text-4xl font-black text-gray-900">Sob Consulta</span>
                                </div>
                                <p className="text-gray-400 text-sm mt-2">Para franquias e múltiplas lojas.</p>
                            </div>
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-center gap-3 text-gray-600 font-medium">
                                    <Check className="h-5 w-5 text-[#ff3d03]" />
                                    Multi-lojas centralizado
                                </li>
                                <li className="flex items-center gap-3 text-gray-600 font-medium">
                                    <Check className="h-5 w-5 text-[#ff3d03]" />
                ...
                <div className="max-w-3xl mx-auto px-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <FaqItem
                            ...
                            answer="Com o módulo ÓoPrint (incluso no plano Profissional), você instala nosso gerenciador no seu computador com Windows e os pedidos são impressos automaticamente na sua impressora térmica assim que chegam."
                        />
                        <FaqItem
